...
var Box = /** @class */ (function () {
    ...
    Box.prototype.ifElse = function (assertion, onTrue, onFalse) {
        ...
        // enforce all are async
        var _a = [assertion, onTrue, onFalse].map(function (fn) { return function (box) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, fn(box)];
        }); }); }; }), assertionP = _a[0], onTrueP = _a[1], onFalseP = _a[2];
        this._requestors.push(function (box) {
            return assertionP(box).then(function (flag) {
                if (flag)
                    return onTrueP(box);
